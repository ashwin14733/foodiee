...
const Sliderone = () => {
  ...
  const el = useRef(null);
    const typedInstance = useRef(null);
        ...
        React.useEffect(() => {
           if (el.current && typeof Typed !== 'undefined') {
          const typed = new Typed(el.current, {
            strings: ['Green goodness meets creamy perfection! 💚🧀', 'Coffee is my love language! 💕☕','Fresh, fruity, fabulous! ✨🍓',"The perfect breakfast comfort food!",'Taste of tradition in every bite! 🏛️👅','Starting strong with oats!'],
            typeSpeed: 40,
            backSpeed:20,
            loop:true,
          });
  ...
  const headphones = [
    ...
    { 
      image: "https://file.aiquickdraw.com/imgcompressed/img/compressed_eca56bb9bc227aed44218b824d23c172.webp", 
      alt: "Blue beverage",
      background: "radial-gradient(50% 50% at 50% 50%, #D1E4F6 0%, #5F9CCF 100%)"
    },
    { 
      image: "https://mychickenexpress.in/wp-content/uploads/2024/02/Fried-Chicken.png", 
      alt: "Red beverage",
    ...
    { 
      image: "https://static.vecteezy.com/system/resources/previews/054/602/828/non_2x/plate-of-chicken-chettinad-curry-free-png.png", 
      alt: "White beverage",
      background: "radial-gradient(50% 50% at 50% 50%, #D7D7D7 0%, #979797 100%)"
    },
    { 
      image: "https://rosepng.com/wp-content/uploads/2024/09/s11728_veg_thali_isolated_on_white_background_59ef9727-5688-4c26-8774-07e7c4b937da_3-photoroom.png", 
      alt: "Black beverage",
        ...
        <div className="containerone">
          ...
          <div className="slider-content-wrap">
            <div className="slider-content">
              ...
              <h3 className="heading-style-2">$199.99</h3>
