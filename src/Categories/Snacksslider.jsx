...
const Sliderone = () => {
  ...
  const headphones = [
    { 
      image: "https://www.aussieblends.com/uploads/5/6/8/9/56893801/premium-ice-cream-mix-aussieblends_orig.png", 
      alt: "Green beverage",
      background: "radial-gradient(50% 50% at 50% 50%, #C7F6D0 0%, #7CB686 92.19%)"
    },
    { 
      image: "https://static.vecteezy.com/system/resources/previews/068/201/232/non_2x/roasted-chickpeas-in-a-blue-bowl-a-healthy-snack-or-side-dish-free-png.png", 
      alt: "Blue beverage",
    ...
    { 
      image: "https://rosepng.com/wp-content/uploads/2024/09/s11728_pani_puri_isolated_on_white_background_31295d28-d04f-4a69-9c34-67d8dd234565_0-photoroom.png", 
      alt: "White beverage",
      background: "radial-gradient(50% 50% at 50% 50%, #D7D7D7 0%, #979797 100%)"
    },
    { 
      image: "https://kaiserfoodline.com/wp-content/uploads/2024/09/Punjabi-Chicken-Samosa-resized-min.png", 
      alt: "Black beverage",
  ...
  const el = React.useRef(null);
      ...
      React.useEffect(() => {
        const typed = new Typed(el.current, {
          strings: ['Going nuts for this green dream! 🥜💚', "Grandma's recipe, pure soul food ❤️","Mumbai's heart and soul on a plate! 💛🧡","Crunch, munch, and pure bliss! 🎉",'One shot, pure bliss! 💥','Golden triangles of pure joy! 🔺✨'],
          typeSpeed: 40,
          loop:true,
        });
          ...
          <div className="slider-content-wrap">
            <div className="slider-content">
              ...
              <span ref={el} />
                ...
                <p>Share what truly resonates with you and your meal. 
                Add popular hashtags like #foodie, #instafood, #foodphotography, and #delicious to increase visibility.</p> 
