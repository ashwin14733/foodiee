      ...
      <div>
        <div className="cards">
          <div className="card1 ">
           ...
           <div className="card1">
            <Link to={'/chatitems'}><img src="https://static.vecteezy.com/system/resources/previews/054/721/780/non_2x/street-snack-delight-indian-pani-puri-png.png" alt="Chat items"  width={"150px"}/></Link>
            <p>Chat Items</p>
          </div>
        </div>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade m-5 p-5">
