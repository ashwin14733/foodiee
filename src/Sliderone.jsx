...
const Sliderone = () => {
  ...
  React.useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ['Crunch meets comfort in every bite! 🤤', 'Minty fresh meets ocean blue! 🌊🍃','Crispy, tangy, absolutely addictive! 💥',"Sweet indulgence you can't resist! 😍🥤",'Choco-coffee bliss! ✨☕'],
      typeSpeed: 40,
      loop:true,
    });
  ...
  const headphones = [
    { 
      image: "https://static.vecteezy.com/system/resources/previews/053/110/027/non_2x/a-plate-of-spring-rolls-with-vegetables-and-salad-free-png.png", 
      alt: "Green beverage",
      background: "radial-gradient(50% 50% at 50% 50%, #C7F6D0 0%, #7CB686 92.19%)"
    },
    { 
      image: "https://file.aiquickdraw.com/imgcompressed/img/compressed_61b5fa087feb8ce033d1ee80ab3730ec.webp", 
      alt: "Blue beverage",
      background: "radial-gradient(50% 50% at 50% 50%, #D1E4F6 0%, #5F9CCF 100%)"
    },
    { 
      image: "https://static.vecteezy.com/system/resources/previews/051/043/751/non_2x/a-plate-of-colorful-indian-bhel-puri-or-pani-puri-with-lime-and-fresh-vegetables-isolated-on-transparent-background-for-food-product-banners-and-covers-free-png.png", 
      alt: "Red beverage",
    ...
    { 
      image: "https://static.vecteezy.com/system/resources/previews/055/931/407/non_2x/creamy-chocolate-milkshake-topped-with-whipped-cream-and-mint-leaves-is-served-in-a-glass-with-pieces-of-rich-dark-chocolate-free-png.png", 
      alt: "Black beverage",
        ...
        <div className="containerone">
          ...
          <div className="slider-content-wrap">
            <div className="slider-content">
              ...
              <span ref={el} />
                {/* Share what truly resonates with you and your meal. 
                Add popular hashtags like #foodie, #instafood, #foodphotography, and #delicious to increase visibility.  */}
              </p>
              <h3 className="heading-style-2">$79.99</h3>
